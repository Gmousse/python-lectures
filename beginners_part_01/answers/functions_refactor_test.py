...
# -*- coding: utf-8 -*-
"""
Exercices pratiques autour du refactor par les fonctions.
...
class Test_functions_refactor(unittest.TestCase):
    ...
    def test_treat_records(self):
        ...
        def analyze(daily_records):
            ...
            daily_results = build_daily_results(daily_records)
            mean_result = mean([result["result"] for result in daily_results])
            # STOP HERE
